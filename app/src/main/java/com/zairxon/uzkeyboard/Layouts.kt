...
object Layouts {
    ...
    // ---- Огласовки (харакат) — на месте Shift в арабской раскладке ----
    // Tap = фатха; долгое нажатие = дамма/касра/шадда/сукун/танвин. Комбинируются с
    // предыдущей буквой (بَ بُ بِ …). Метка ◌ — пунктирный круг для наглядности.
    private val harakat = Key(
        label = "◌َ",           // ◌َ  фатха
        output = "َ",                // فتحة  фатха
        alternates = listOf(
            "ُ", // ُ  ضمة        дамма
            ...
            "ّ", // ّ  شدّة        шадда
            "ْ", // ْ  سكون       сукун
            "ً", // ً  تنوين فتح  танвин фатх
            "ٌ", // ٌ  تنوين ضم   танвин дамм
            "ٍ"  // ٍ  تنوين كسر  танвин касра
        ),
        weight = 1.5f
    )
